<html>
	<head>
		<title>eVenture - Advertise an Event</title>
        ...
        <link rel="stylesheet" href="css/advertiseevent.css">
      ...
      <div id = "container">
        <div class = "row center">  
          <div class="col s6 offset-s3 z-depth-5" id = "content-div">
                  <form class="col s12" id = "edit-profile-form" action = "AdvertiseEventServlet" method="post">
                      <div class='row'>
                        <div class='col s12 center-align'>
                          <img src = "Photos/advertise.png" class = "homepage_icon"/>
                          <h4>ADVERTISE AN EVENT SERVICE</h4>
                        </div>
                      </div>

                        <div class="row">
                          <div class="input-field col s6" id="namediv">
                            <span class = "labels left">Name</span>
                            <input name = "eventName" id="eventName" type="text" minlength = "2" maxlength = "45" class="validate" required = "">
                          </div>
                        </div>
                        ...
                        <div class="row">
                           ...
                           <div class="input-field col s6">
                            <span class = "labels left">Category</span><br>
                              <select name = "categoryID" id="category" class="browser-default" required = "">
                                <option value="" disabled selected>Choose Category</option>
                                <option value="1">Photography & Videography</option>
                                <option value="2">Venue & Catering</option>
                                <option value="3">Make-up Artist</option>
                                <option value="4">Fashion Design</option>
                                <option value="5">Sounds & Lights</option>
                              </select>
                          </div>

                          <div class="input-field col s6">
                            <span class = "labels left">Location</span>
                            <select name="eventLocation" id="location" class="browser-default" required = "">
                        ...
                        <div class="row">
                          <div class="input-field col s12">
                            <span class = "labels left">Description</span>
                        ...
                        <div class="row">
                          <div class="input-field col s12">
                            <span class = "labels left">Prices and Packages</span>
                            <textarea name = "packages" id="prices" class="validate"></textarea>
                          </div>
                        </div>

                        <div class="row">
                          <div class="input-field col s12">
                            <span class = "labels left">Websites</span>
                            <textarea  name = "website" id="websites" class="validate"></textarea>
                          </div>
                        </div>
                    ...
                    <center>
                      <div class='row col s6 offset-s3'>
                        <button type='submit' name='btn_login' class='col s12 brown btn btn-large waves-effect indigo'>ADVERTISE EVENT</button>
                      </div>
                    </center>
                  </form>
