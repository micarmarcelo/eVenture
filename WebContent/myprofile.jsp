...
<html>
      ...
      <div id = "container">
        <div class = "row center-align">  
           <div class="container about">
              <h5><%= session.getAttribute("firstName") %> <%= session.getAttribute("lastName") %></h5>
                ...
                <div class="col s12 m4 l4">
                  ...
                  <table class = "bordered striped">
                    <tbody>
                      ...
                      <tr>
                        <td> Email Address: </td>
                        <td> <%= session.getAttribute("emailAddress")%> </td>
                      </tr>
                      ...
                      <tr>
                        <td>  Bio: </td>
                        <td> <%= session.getAttribute("bio")%> </td>
                      </tr>
	...
	<script type="text/javascript">
		...
		var Adv ='<%=request.getAttribute("getAlert")%>';
		    ...
		    if (Msg == "update") {
		    ...
		    else if (Msg == "advertise"){
				function alertName(){
		 			swal({title: "Hooray!", 
		 				text: "You advertised an event successfully!", 
		 				type: "success",
		 				timer: 3000,
		 				showConfirmButton: false	
		 			});	
		    	...
		    	function alertName(){
		 			swal({   title: "Welcome to Eventure!",   
		 				text: "You can add more information in Edit Profile.",   
		 				timer: 3500,   
		 				showConfirmButton: false 
		 			});
				} 
